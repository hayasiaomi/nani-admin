        ...
        <div id="page-wrapper">
            <div class="panel panel-info">
                <div class="panel-heading">
                    增加SKU属性 <a class="btn btn-success btn-xs" href="/sku">返回</a>
                </div>
                <div class="panel-body table-responsive">
                    <form action="/sku/add" method="post" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <label class="radio-inline">
                                    <input type="radio" name="selectable" id="isOnLine" value="1" checked>是
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="selectable" id="isOnLine" value="0">否
                                </label>
                            </div>
                        </div>
