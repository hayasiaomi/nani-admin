        ...
        <div id="page-wrapper">
            <div class="panel panel-info">
                <div class="panel-heading">
                    编辑商品分类 <a class="btn btn-success btn-xs" href="/category">返回</a>
                </div>
                <div class="panel-body table-responsive">
                    <form action="/category/edit" method="post" class="form-horizontal" role="form">

                        <div class="form-group">
                            <label for="productName" class="col-sm-2 control-label">所属父类名</label>
                            <div class="col-sm-4">
                                <span class="label label-success">${parentName!'无'}</span>
                            </div>
                        </div>
