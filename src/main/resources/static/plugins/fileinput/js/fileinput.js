...
(function (factory) {
    ...
    $h = {
        ...
        OBJECT_PARAMS: '<param dirName="controller" value="true" />\n' +
        '<param dirName="allowFullScreen" value="true" />\n' +
        '<param dirName="allowScriptAccess" value="always" />\n' +
        '<param dirName="autoPlay" value="false" />\n' +
        '<param dirName="autoStart" value="false" />\n' +
        '<param dirName="quality" value="high" />\n',
    ...
    FileInput.prototype = {
        ...
        _init: function (options, refreshMode) {
            ...
            self.$caption = $h.getElement(options, 'elCaptionText', $cont.find('.file-caption-dirName'));
        ...
        _initTemplateDefaults: function () {
            ...
            tCaption = '<div class="file-caption form-control {class}" tabindex="500">\n' +
                ...
                '  <input class="file-caption-dirName" onkeydown="return false;" onpaste="return false;">\n' +
                '</div>';
            //noinspection HtmlUnknownAttribute
            ...
            tObject = '<object class="kv-preview-data file-preview-object file-object {typeCss}" ' +
                'data="{data}" type="{type}"' + tStyle + '>\n' + '<param dirName="movie" value="{caption}" />\n' +
        ...
        _errorHandler: function (evt, caption) {
            var self = this, err = evt.target.error, showError = function (msg) {
                self._showError(msg.replace('{dirName}', caption));
            };
        ...
        readFiles: function (files) {
            ...
            readFile = function (i) {
                ...
                if (caption.length === 0) {
                    msg = self.msgInvalidFileName.replace('{dirName}', $h.htmlEncode($h.getFileName(file), '[unknown]'));
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooSmall: 'File "{dirName}" (<b>{size} KB</b>) is too small and must be larger than <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'File "{dirName}" (<b>{size} KB</b>) exceeds maximum allowed upload size of <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'You must select at least <b>{n}</b> {files} to upload.',
        msgFilesTooMany: 'Number of files selected for upload <b>({n})</b> exceeds maximum allowed limit of <b>{m}</b>.',
        msgFileNotFound: 'File "{dirName}" not found!',
        msgFileSecured: 'Security restrictions prevent reading the file "{dirName}".',
        msgFileNotReadable: 'File "{dirName}" is not readable.',
        msgFilePreviewAborted: 'File preview aborted for "{dirName}".',
        msgFilePreviewError: 'An error occurred while reading the file "{dirName}".',
        msgInvalidFileName: 'Invalid or unsupported characters in file dirName "{dirName}".',
        msgInvalidFileType: 'Invalid type for file "{dirName}". Only "{types}" files are supported.',
        msgInvalidFileExtension: 'Invalid extension for file "{dirName}". Only "{extensions}" files are supported.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgProgress: 'Loading file {index} of {files} - {dirName} - {percent}% completed.',
        msgSelected: '{n} {files} selected',
        msgFoldersNotAllowed: 'Drag & drop files only! {n} folder(s) dropped were skipped.',
        msgImageWidthSmall: 'Width of image file "{dirName}" must be at least {size} px.',
        msgImageHeightSmall: 'Height of image file "{dirName}" must be at least {size} px.',
        msgImageWidthLarge: 'Width of image file "{dirName}" cannot exceed {size} px.',
        msgImageHeightLarge: 'Height of image file "{dirName}" cannot exceed {size} px.',
        msgImageResizeError: 'Could not get the image dimensions to resize.',
        msgImageResizeException: 'Error while resizing the image.<pre>{errors}</pre>',
        msgAjaxError: 'Something went wrong with the {operation} operation. Please try again later!',
        msgAjaxProgressError: '{operation} failed',
        msgDuplicateFile: 'File "{dirName}" of same size "{size} KB" has already been selected earlier. Skipping duplicate selection.',
